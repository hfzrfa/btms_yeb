...
<body>
    ...
    <table>
        ...
        <?php foreach ($categories as $cat): $v = $rowData[$cat] ?? ['idr' => 0, 'sgd' => 0, 'yen' => 0]; ?>
            <?php if ($cat === 'Daily Allowance'): ?>
                <tr class="expense-row">
                    <td rowspan="4">Daily Allowance</td>
                    <td rowspan="4" style="padding:0;">
                        <table class="da-sub" style="width:100%;">
                            <tr>
        ...
        <tr>
            <td colspan="5" class="nob" style="padding:0;">
                <table class="subgrid" style="width:100%; border-collapse:collapse;">
                    <tr>
                        <td style="width:219px; border:1px solid #000;" class="center shade">Return To Accounting</td>
    ...
    <table class="circ">
        ...
        <tr>
            <td style="width:190px;" class="shade">Date Of Payment</td>
            <td></td>
    ...
    <table class="sign-hdr center">
        <tr>
            <td style="width: 120px;">Claimed by</td>
