...
$cols = [];
try { $cols = $pdo->query("SHOW COLUMNS FROM trips")->fetchAll(PDO::FETCH_COLUMN,0); } catch(Exception $e) {}
  ...
  <?php $i=1; foreach($rows as $r): ?>
    <tr>
      ...
      <td data-label="Status">
        <?php $badge='secondary'; if($r['status']==='approved') $badge='success'; elseif($r['status']==='pending') $badge='warning'; elseif($r['status']==='rejected') $badge='danger'; elseif($r['status']==='cancelled') $badge='dark'; ?>
