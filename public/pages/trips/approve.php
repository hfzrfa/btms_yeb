...
$pdo = getPDO();
// Self-heal trip_approvals.id AUTO_INCREMENT (prevents 1364 errors when inserting approval rows)
try {
...
$approvalCols = [];
try {
  $approvalCols = $pdo->query("SHOW COLUMNS FROM trip_approvals")->fetchAll(PDO::FETCH_COLUMN, 0);
} catch (Exception $e) {
}
